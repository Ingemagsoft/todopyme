@extends('layouts.app', ['title' => 'Nuevo cliente — todopyme'])

@section('page-content')

    <div class="d-flex align-items-center justify-content-between mb-3">
        <h4 class="fw-semibold mb-0">Nuevo cliente</h4>
    ...
    <form method="POST" action="{{ route('clientes.store') }}">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="codigo" id="codigo"
                            ...
                            value="{{ old('codigo') }}" placeholder="Ej: CLI001" autocomplete="off">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="numero_documento" id="numero_documento"
                            ...
                            value="{{ old('numero_documento') }}" placeholder="Sin puntos ni espacios" autocomplete="off">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="digito_verificacion" id="digito_verificacion"
                            class="form-control" value="{{ old('digito_verificacion') }}"
                ...
                {{-- Bloque jurídico — visible si hay DV --}}
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="rep_legal_primer_nombre" id="rep_legal_primer_nombre"
                                class="form-control" value="{{ old('rep_legal_primer_nombre') }}" placeholder="Primer nombre">
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="text" name="rep_legal_segundo_nombre" id="rep_legal_segundo_nombre"
                                class="form-control" value="{{ old('rep_legal_segundo_nombre') }}" placeholder="Segundo nombre">
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="text" name="rep_legal_primer_apellido" id="rep_legal_primer_apellido"
                                class="form-control" value="{{ old('rep_legal_primer_apellido') }}" placeholder="Primer apellido">
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="text" name="rep_legal_segundo_apellido" id="rep_legal_segundo_apellido"
                                class="form-control" value="{{ old('rep_legal_segundo_apellido') }}" placeholder="Segundo apellido">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="rep_legal_documento" id="rep_legal_documento"
                                class="form-control" value="{{ old('rep_legal_documento') }}" placeholder="Número de documento">
                        </div>
                    </div>
                </div>

                {{-- Bloque natural — visible si NO hay DV --}}
                ...
                <div class="row mb-0">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="telefono" id="telefono" class="form-control"
                            value="{{ old('telefono') }}" placeholder="Sin espacios ni comas">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label" for="celular">Celular</label>
                        <input type="text" name="celular" id="celular" class="form-control"
                            value="{{ old('celular') }}" placeholder="Sin espacios ni comas">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary px-5">
                    <i class="ri-save-line align-middle me-1"></i> Grabar cliente
                </button>
            </div>
        </div>
